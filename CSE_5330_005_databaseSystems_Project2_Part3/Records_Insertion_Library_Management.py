...
mydb = mysql.connector.connect(host="acadmysqldb001p.uta.edu", user="cxm1569", password="AzZXWD@6iRG4", database="cxm1569")
...
with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\library.csv') as f1:
...
with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\publisher.csv') as f2:
...
with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\books.csv') as f3:
         ...
         for i in range(len(books_data)):
           if i == 0:
            ...
            print(books_data[i])
            mycursor.execute("INSERT INTO BOOK VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", [books_data[i][0], books_data[i][1],books_data[i][2],books_data[i][3],books_data[i][4],books_data[i][5],books_data[i][6],books_data[i][7],books_data[i][8],books_data[i][9],books_data[i][10],books_data[i][11]])
...
with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\member.csv') as f4:
...
with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\author.csv') as f5:
...
with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\book_author.csv') as f6:
         ...
         for i in range(len(book_author_data)):
           if i == 0:
            ...
            mycursor.execute("INSERT INTO BOOKS_AUTHOR VALUES(%s,%s,%s,%s)", [book_author_data[i][0], book_author_data[i][1], book_author_data[i][2], book_author_data[i][3]])
print("VALUES INSERTED INTO THE BOOK_AUTHOR TABLE")
f6.close()

with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\book_available.csv') as f7:
         ...
         for i in range(len(book_available_data)):
           if i == 0:
            ...
            mycursor.execute("INSERT INTO BOOKS_AVAILABLE VALUES(%s,%s,%s)", [book_available_data[i][0], book_available_data[i][1],book_available_data[i][2]])
print("VALUES INSERTED INTO THE BOOK_AVAILABLE TABLE")
f7.close()

with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\book_require.csv') as f8:
         ...
         for i in range(len(us_book_require_data)):
           if i == 0:
            ...
            mycursor.execute("INSERT INTO BOOKS_REQUIRE VALUES(%s,%s)", [us_book_require_data[i][0], us_book_require_data[i][1]])
print("VALUES INSERTED INTO THE BOOK_REQUIRE TABLE")
f8.close()

with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\lib_staff.csv') as f9:
...
with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\book_issue.csv') as f10:
         ...
         for i in range(len(book_issue_data)):
           if i == 0:
            ...
            mycursor.execute("INSERT INTO BOOKS_ISSUE VALUES(%s,%s,%s,%s,%s,%s,%s,%s)", [book_issue_data[i][0], book_issue_data[i][1], book_issue_data[i][2], book_issue_data[i][3], book_issue_data[i][4], book_issue_data[i][5], book_issue_data[i][6], book_issue_data[i][7]])
print("VALUES INSERTED INTO THE BOOK_ISSUE TABLE")
f10.close()

with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\lib_staff_member.csv') as f11:
...
with open(r'C:\Users\KARTHIK\Downloads\CSE_5330_005_databaseSystems_Project2_Part3\Data\member_phone.csv') as f12:
